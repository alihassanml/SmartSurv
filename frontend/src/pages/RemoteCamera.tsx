...
const RemoteCamera: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#060608] text-[#00ff85] font-mono p-6 flex flex-col items-center justify-center relative overflow-hidden">
            {/* Background Grid */}
            <div className="absolute inset-0 opacity-10 pointer-events-none"
              style={{ backgroundImage: 'linear-gradient(rgba(0,255,133,0.06) 1px,transparent 1px),linear-gradient(90deg,rgba(0,255,133,0.06) 1px,transparent 1px)', backgroundSize: '40px 40px' }} />

            {/* Header */}
            <div className="relative z-10 w-full max-w-md mb-8 flex items-center justify-between border-b border-[rgba(0,255,133,0.2)] pb-4">
                ...
                <div className="text-right">
                    <div className="flex items-center gap-2 justify-end">
                        <div className={`w-2 h-2 rounded-full ${status === 'streaming' ? 'bg-[#00ff85] animate-ping' : 'bg-red-500'}`} />
            ...
            <div className="relative z-10 w-full mb-4 max-w-md p-2 border border-[rgba(0,255,133,0.1)] text-[8px] flex justify-between uppercase opacity-40">
            ...
            {/* Viewfinder */}
            <div className="relative z-10 w-full max-w-md aspect-[4/3] bg-[#000] border border-[rgba(0,255,133,0.2)] overflow-hidden shadow-[0_0_30px_rgba(0,255,133,0.05)]">
                <video ref={videoRef} autoPlay playsInline muted className="w-full h-full object-cover grayscale brightness-125" />
                <canvas ref={canvasRef} width={640} height={480} className="hidden" />
                
                {/* Visual Overlays */}
                <div className="absolute inset-x-8 top-1/2 -translate-y-1/2 h-0.5 bg-[#00ff85]/20 animate-pulse" />
                <div className="absolute inset-y-8 left-1/2 -translate-x-1/2 w-0.5 bg-[#00ff85]/20 animate-pulse" />
            ...
            <div className="relative z-10 w-full max-w-md mt-8 space-y-4">
                {status === 'idle' ? (
                    <button 
                        ...
                        className="w-full py-4 border-2 border-[#00ff85] bg-[rgba(0,255,133,0.05)] font-bold tracking-[0.3em] uppercase hover:bg-[#00ff85] hover:text-black transition-all duration-300 flex items-center justify-center gap-3"
                    >
                ...
                <div className="p-4 border border-[rgba(0,255,133,0.1)] text-[10px] opacity-50 leading-relaxed text-center">
